...
export const Header = () => {
  return (
    <CustomPageHeader
      ...
      text="Во нашиот каталог можете да најдете само дел од нашата богата понуда на авто делови.Се олеснува информирањето  и купувањето на автомобилски делови преку интернет.Располагаме со сите видови на авто делови за сите типови на возила.За сите потребни авто делови можете да не исконтактира преку контакт броевите или да ни пишете mail"
    />
  );
};
